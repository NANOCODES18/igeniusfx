    ...
    <div class="row justify-content-between align-items-center gutter-vr-30px">
        ...
        <div class="col-lg-8">
            <div class="text-block">
                <h5 class="heading-xs dash">igenius fx </h5>
    ...
    <div class="row justify-content-center gutter-vr-30px">
        <div class="col-12">
            <div class="text-box service-box bg-secondary h-full">
                <h4 class="fw-6 mtm-5">Why trade Cryptocurrencies with igenius fx ?</h4>
                                        <p>
                                           Cryptocurrencies could potentially be the currency of the future with more people gaining interest and price
                        value going up. igenius fx  offers competitive spreads, with no commissions charged on transactions making it
                        more profitable. When trading with igenius fx  you are trading on the price changes of the digital coin, and not
                        physically purchasing it.
                        Trading with igenius fx  ensures that you will trade with a 100% reputable broker.
