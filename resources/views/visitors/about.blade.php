    ...
    <div class="row justify-content-between gutter-vr-30px"><!-- .col -->
        <div class="col-lg-12">
            ...
            <div class="image-block">
                ...
                <p class="lead">
                                        igenius fx  is an experienced team dedicated to providing the best investment experience
                    ...
                    <div class="col-12 col-xl-6 p-lg-0">
                        <div class="text-box team-pad">
                            ...
                            <p class="tc-grey">Benefit from tailored solutions that meet your needs. Over 100 tradable assets and unlimited market access</p>
                                        ...
                                        <br><br>
                <p>
                    igenius fx  is a conglomerate of igenius fx LLC, located in Seattle , Washington. The company was registered on 2004-08-31 with company number 602425294 with MYERS, ANDREW CHRISTOPHER as the CHIEF EXECUTIVE OFFICER, we have
...
igenius fx  have had a very strong relationship with equity and funding providers
...
to perfect their duty owed to igenius fx  investors and also aid in providing access
to appropriate specialists dependent on the type of transaction being undertaken.
<br>
<br>
Whatever the investment capacity you have in mind, igenius fx  is committed to providing you with a
...
success with igenius fx  by starting up your investments now !!
                                        </p>
            </div><!-- .text-block  -->
        </div><!-- .col -->
    </div><!-- .row -->
