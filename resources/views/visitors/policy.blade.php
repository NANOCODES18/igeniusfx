    ...
    <div class="container">
        ...
        <div class="col-lg-8 text-center">
            <div class="section-head section-md">
                <h5 class="heading-xs dash dash-both">igenius fx </h5>
                <h2>Our Policy</h2>
        ...
        <div class="col-lg-8 text-center">
            <div class="section-head section-md">
                                    <h2>Contact Information</h2>
                                        <p>igenius fx  is glad to receive your comments concerning this "Privacy Policy". In case you think that igenius fx  does not follow the rules and violate this Statement, contact us at <a href='mailto:{{$compd? $compd->companyemail : "coming soon"}}'>{{$compd? $compd->companyemail : "coming soon"}}</a> We guarantee that we will take commercially reasonable efforts to discover and solve the problem.</p>
            </div>
        </div>
    </div>
    </div><!-- .container -->
